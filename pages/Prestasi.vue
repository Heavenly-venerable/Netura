  ...
  <main class="min-h-screen pt-20 pb-16">
    ...
    <div class="max-w-6xl mx-auto px-4 pt-12">
      <div class="grid grid-cols-2 md:grid-cols-5 gap-3 mb-12">
        <div
          class="p-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-md text-center">
        ...
        <div
          class="p-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-md text-center col-span-2 md:col-span-1">
    ...
    <div class="max-w-6xl mx-auto px-4">
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div class="flex items-center gap-2">
          <button
            class="px-3 py-1.5 text-xs border border-gray-200 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            Semua
          </button>
          <button
            class="px-3 py-1.5 text-xs border border-gray-200 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
      ...
      <div class="mb-12">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 class="text-lg font-medium text-gray-900 dark:text-white">Prestasi Akademik</h2>
          <span
            class="text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full">
            {{ prestasiAkademik.length }} Prestasi
          </span>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div v-for="item in prestasiAkademik" :key="item.id"
            class="group border border-gray-100 dark:border-gray-800 rounded-md hover:border-amber-200 dark:hover:border-amber-900 transition-colors overflow-hidden">
            <div class="p-4">
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex flex-wrap items-center gap-2 text-xs">
                    <span
                      class="bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full">
                      {{ item.tingkat }}
                    </span>
      ...
      <div class="mb-12">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h2 class="text-lg font-medium text-gray-900 dark:text-white">Prestasi Non Akademik</h2>
          <span
            class="text-xs bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2 py-0.5 rounded-full">
            {{ prestasiNonAkademik.length }} Prestasi
          </span>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div v-for="item in prestasiNonAkademik" :key="item.id"
            class="group border border-gray-100 dark:border-gray-800 rounded-md hover:border-amber-200 dark:hover:border-amber-900 transition-colors overflow-hidden">
            <div class="p-4">
              <div class="flex items-start gap-3">
                <!-- Foto/Avatar -->
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex flex-wrap items-center gap-2 text-xs">
                    <span
                      class="bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 px-2 py-0.5 rounded-full">
                      {{ item.tingkat }}
                    </span>
                    <span class="text-gray-400 dark:text-gray-500">{{ item.tahun }}</span>
                  </div>
      ...
      <div class="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-md">
        ...
        <div class="flex items-end gap-2 h-32">
          <div class="flex-1 flex flex-col items-center">
            <div class="w-full bg-amber-200 dark:bg-amber-900/50 rounded-t" style="height: 80px"></div>
            <span class="text-xs mt-2 text-gray-600 dark:text-gray-400">2021</span>
          </div>
          <div class="flex-1 flex flex-col items-center">
            <div class="w-full bg-amber-300 dark:bg-amber-800/50 rounded-t" style="height: 100px"></div>
            <span class="text-xs mt-2 text-gray-600 dark:text-gray-400">2022</span>
          </div>
          <div class="flex-1 flex flex-col items-center">
            <div class="w-full bg-amber-400 dark:bg-amber-700/50 rounded-t" style="height: 120px"></div>
            <span class="text-xs mt-2 text-gray-600 dark:text-gray-400">2023</span>
          </div>
          <div class="flex-1 flex flex-col items-center">
            <div class="w-full bg-amber-500 dark:bg-amber-600/50 rounded-t" style="height: 140px"></div>
